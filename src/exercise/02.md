...
1. React executes all lazy initializers (for instance, functions inside
   useState)
2. React runs the render function
3. React executes the effects (e.g., useEffect functions)

### Component Updating

1. React runs the render function
2. React executes the cleanup effect functions for those impacted effects
3. React runs the affected effects

### Component Unmounting

1. React executes the cleanup function for all effects

> Create anki card for each phase
